...
class PuzzleView:
    ...
    def draw_puzzle(self,problem):
        ...
        font = pygame.font.Font('../assets/fonts/cascadia-code/Cascadia.ttf', 60)
    ...
    def puzzle_string(self,powerlevel, numberofterms, depth):
        ...
        listofNumbers, answer, operator = self.power_level_operators(powerlevel, numberofterms, depth)
